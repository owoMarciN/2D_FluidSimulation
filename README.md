...
As for now the code only works for **Windows Systems**. Plase note that you need to download and install the SDL3 library and change the path to the SDL3 library directory in the `run.bat` file.
